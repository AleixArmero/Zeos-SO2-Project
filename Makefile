...
SYSOBJ = interrupt.o entry.o sys_call_table.o io.o sched.o sys.o mm.o devices.o utils.o hardware.o list.o p_stats.o kernel-utils.o cir_buff.o

LIBZEOS = -L . -l zeos -l auxjp

#add to USROBJ the object files required to complete the user program
USROBJ = libc.o user-utils.o slabs.o list.o# libjp.a
...
slabs.o:slabs.c $(INCLUDEDIR)/slabs.h $(INCLUDEDIR)/libc.h
...
cir_buff.o:cir_buff.c $(INCLUDEDIR)/cir_buff.h
